...
def train(model, imgs_train, imgs_labels):
    model.fit(imgs_train, imgs_labels, batch_size=8, nb_epoch=20, verbose=1, shuffle=True,
...
if __name__ == "__main__":
    ...
    model_checkpoint = ModelCheckpoint('./weights/resnet.hdf5', monitor='loss', save_best_only=True)
    ...
    score = model.evaluate( test_imgs, test_labels,batch_size=8 )
